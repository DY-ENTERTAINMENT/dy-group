...
function getDefaultPermissionKeys(name: string) {
  if (name.trim().toUpperCase() === 'HR ADMIN') {
    return ['hr', 'staff', 'registration-review', 'leave-review', 'leave-balance-management', 'attendance-management', 'attendance-locations', 'creator-adjustment-review'];
  }
  if (name.includes('HR')) return ['hr', 'staff', 'registration-review', 'leave-review', 'leave-balance-management', 'attendance-management', 'attendance-locations'];
