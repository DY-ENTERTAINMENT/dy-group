...
export type CreatorActivityType = 'guild_activity' | 'live' | 'shooting' | 'offline_activity' | 'other';
export type CreatorActivity = { id: string; creator_entity_id: string; agent_employee_id: string; title: string; activity_date: string; activity_time: string | null; activity_type: CreatorActivityType; agent_remark: string | null; lead_remark: string | null; lead_remark_by: string | null; lead_remark_updated_at: string | null; created_at: string; updated_at: string; };
