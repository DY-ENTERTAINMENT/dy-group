...
-- Keep canonical reporting behavior unchanged while qualifying the CTE columns
-- that share names with RETURNS TABLE output variables in this PL/pgSQL function.
